   ...
   $("#Editbox12").on("click focus", function() { $(this).val("")});
   });
   $(document).ready(function() {
   $("#Editbox12").on("keyup input change", function() {if (this.value.match(/[^0-9]/g)) {this.value = this.value.replace(/[^0-9]/g, '');} });});
   ...
   $("#Editbox6").on("click focus", function() { $(this).val("")});
   });
   $(document).ready(function() {
   $("#Editbox6").on("keyup input change", function() {if (this.value.match(/[^0-9]/g)) {this.value = this.value.replace(/[^0-9]/g, '');} });});
   ...
   $(document).ready(function()
   {
    ...
    $('#Editbox2,#Editbox5,#Editbox19,#Editbox22,#Editbox30,#Editbox33').mask("+7(999)999-99-99");

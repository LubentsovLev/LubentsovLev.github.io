$(function () {
  ...
  //links
  const change_inn = function (link, arr) {
    link.addEventListener("click", () => {
      services__info_items.innerHTML = "";
      services__info_items.innerHTML = `
      ${arr
        .map(
          (i) =>
